...
static void
_ng_border_cb_border_menu_end(void *data EINA_UNUSED, E_Menu *m)
{
   E_Border *bd;
...
static void
_ng_border_menu_cb_close(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi EINA_UNUSED)
{
...
static void
_ng_border_menu_cb_iconify(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi EINA_UNUSED)
{
   E_Border *bd = (E_Border *)data;
   if (!bd->lock_user_iconify)
     {
...
static void
_ng_border_menu_cb_maximize(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi EINA_UNUSED)
{
   E_Border *bd = (E_Border *)data;
...
static void
_ng_border_menu_cb_unmaximize(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi EINA_UNUSED)
{
   E_Border *bd = (E_Border *)data;
...
static void
_ng_border_menu_cb_fullscreen(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi)
{
   E_Border *bd = (E_Border *)data;
   int toggle;
