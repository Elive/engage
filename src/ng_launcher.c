...
static Eina_Bool
_cb_icons_update(void *data, int type EINA_UNUSED, void *event EINA_UNUSED)
{
...
static void
_app_change_cb(void *data, E_Order *eo EINA_UNUSED)
{
   Ngi_Box *box = (Ngi_Box *)data;
...
static void
_cb_drop_leave(void *data, const char *type, void *event_info EINA_UNUSED)
{
   Ngi_Box *box = (Ngi_Box *)data;
...
static void
_cb_drag_del(void *data, Evas *e EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
   Ngi_Box *box = data;
...
static void
_cb_drag_finished(E_Drag *d, int dropped EINA_UNUSED)
{
...
static void
_menu_cb_lock_dnd(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi)
{
   Ngi_Box *box = (Ngi_Box *)data;
...
static void
_menu_cb_edit_icon(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi EINA_UNUSED)
{
...
static void
_menu_cb_configure_bar(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi EINA_UNUSED)
{
   Ng *ng = (Ng *)data;
...
static void
_menu_cb_configure_launcher(void *data, E_Menu *m EINA_UNUSED, E_Menu_Item *mi EINA_UNUSED)
{
   Ngi_Box *box = (Ngi_Box *)data;
   char path[4096];
